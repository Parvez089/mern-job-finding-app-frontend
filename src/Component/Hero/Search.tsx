  ...
  return  <div>
      <div className='md:flex flex-row !items-center  hidden !justify-center !content-center '>
        <div className='flex  p-2 !border-2 rounded-l-lg  bg-white'>
          ...
          <Input className='!border-none !outline-none !shadow-none !w-72' />
        </div>
      ...
      <div className='grid grid-cols-1 items-center md:hidden justify-center mt-24 w-full'>
        <div className='flex p-2 border-2 bg-white max-w-full rounded-t-lg'>
        ...
        <div className='flex p-2 !border-x-2 !border-b-2 bg-white border-l-0 rounded-b-lg w-full'>
